					...
					<div class="card-body" style="background-color:#fff;color:black;border:0ch;margin:2px;font-size:small;">
						<div class="table-responsive">
							<table id="dataTable" class="table table-bordered table-hover" width="100%" cellspacing="0">
                                ...
                                $sql = "SELECT * from info_hi where type = 'whatsnew' or type = 'recruitment' or type = 'circular' ORDER BY id DESC LIMIT 15";
                                        ...
                                        if ($query9->rowCount() > 0) {
                                            foreach ($results9 as $result19) {                ?>
                                                        ...
                                                        <td  style="text-align: justify;">
                                                          <a href="admin/hi_doc/<?php echo htmlentities($result19->doc_main); ?>" target="_blank" style="">Document<i class="fa fa-download" aria-hidden="true"></i></a></td>
															<?php }
												} ?>
