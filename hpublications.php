                    ...
                    <div class="row">
                        ...
                        <div class="accordion faq-box" id="accordionExample">
								...
								?>
										...
										<!--Director -->
										<div class="card">
											<div class="card-header" id="heading<?php echo htmlentities($resultx->year); ?>">
												<a class="collapsed" href="javascript:;" data-toggle="collapse" data-target="#collapse<?php echo htmlentities($resultx->year); ?>" aria-expanded="true" aria-controls="collapse<?php echo htmlentities($resultx->year); ?>">
													<?php echo htmlentities($resultx->year); ?>
												</a>
											</div>
											<div id="collapse<?php echo htmlentities($resultx->year); ?>" class="collapse" aria-labelledby="heading<?php echo htmlentities($resultx->year); ?>" data-parent="#accordionExample">
															...
															<table id="dataTable" class="table table-bordered table-hover" width="100%" cellspacing="0">
																<thead>
																	<tr>
																		...
																		<th style="background-color:#fff;color:black;">Year</th>
																...
																<tbody>
																	...
																	$sql = "SELECT * from publication where year = $resultx->year ORDER BY id ASC";
