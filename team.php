...
<body id="bg">
															...
															<div class="client-box style-2">
																...
																<div class="testimonial-text clearfix">
																	<div class="testimonial-detail clearfix">
																		...
																		<span style="color:#000"><?php echo htmlentities($result->emp_desig); ?></span>
																	</div>
																	<p class="card-text"  style="margin-top:5px" id="bg1"><?php echo htmlentities($result->instt_name); ?><br>
																		Research Interest: <?php echo htmlentities($result->research_interest); ?><br>
																		Phone: <?php echo htmlentities($result->emp_contact); ?><br>
																		Email: <?php echo htmlentities($result->emp_email); ?></p>
																</div>
															</div>
														</div>
    ...
    <div class="client-box style-2">
        ...
        <div class="testimonial-text">
            ...
            <p class="card-text" id="bg1">
                <b><?php echo htmlentities($result->emp_name); ?></b></br>
                <?php echo htmlentities($result->emp_desig); ?></br><?php echo htmlentities($result->instt_name); ?><br>
                Research Interest: <?php echo htmlentities($result->research_interest); ?><br>
                Email: <?php echo htmlentities($result->emp_email); ?><br>
                Tel: <?php echo htmlentities($result->emp_contact); ?>
            </p>
            </form>
        </div>
    </div>
														...
														<div class="item">
															<div class="client-box style-2">
																...
																<div class="testimonial-text">
																	...
																	<p class="card-text" ><b><?php echo htmlentities($result->emp_name); ?></b></br>
																		<?php echo htmlentities($result->emp_desig); ?></br>
																		<?php echo htmlentities($result->instt_name); ?></br>
																		Email: <?php echo htmlentities($result->emp_email); ?></br>
																</div>
															</div>
														</div>
															...
															<div class="client-box style-2">
																...
																<div class="testimonial-text">
																	...
																	<p class="card-text" ><b><?php echo htmlentities($result->emp_name); ?></b></br>
																		...
																		<?php echo htmlentities($result->instt_name); ?><br>
																		Email: <?php echo htmlentities($result->emp_email); ?><br>
                                                                        Tel: <?php echo htmlentities($result->emp_contact); ?></p>
															...
															<div class="client-box style-2">
																...
																<div class="testimonial-text">
																	...
																	<p class="card-text" ><b><?php echo htmlentities($result->emp_name); ?></b></br>
																		<?php echo htmlentities($result->emp_desig); ?></br>
																		<?php echo htmlentities($result->instt_name); ?><br>
																		Email: <?php echo htmlentities($result->emp_email); ?><br><br>
																</div>
															</div>
														</div>
