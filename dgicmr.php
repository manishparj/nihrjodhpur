														...
														<div class="item">
															<div class="client-box style-2">
																<div class="testimonial-pic">
																	<img src="admin/img/our_team/dg-icmr/<?php echo htmlentities($result->img); ?>" />
																</div>
																<div class="testimonial-text">

																	<p class="card-text"><b><?php echo htmlentities($result->name_en); ?></b><br>
																	Secretary to Government of India,<br>
																	Department of Health Research and Director General,<br>
																	Indian Council of Medical Research<br></p>
																<a href="https://www.icmr.gov.in/icmr-leadership#ICMRDirector" class="genric-btn success  arrow medium border" style="background-color: #003679;">View Profile »</a>
