                                ...
                                <div class="profile-card h-100">
                                    ...
                                    <div class="profile-card-body">
                                        ...
                                        <div class="profile-designation">
                                            <?php echo htmlentities($result->emp_desig); ?>
                                        </div>
                                        ...
                                        <ul class="nav nav-pills-custom" id="directorTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link active" 
                                                    ...
                                                    role="tab">
                                                    <i class="fas fa-user-graduate mr-2"></i> Profile
                                                </a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link" 
                                                    ...
                                                    role="tab">
                                                    <i class="fas fa-envelope-open-text mr-2"></i> Message
                                                </a>
                                            </li>
                                        </ul>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane fade show active" 
                                                        ...
                                                        <div class="director-content-text">
                                                            <?php echo nl2br(htmlentities($result20->director_profile)); ?>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade" 
                                                        ...
                                                        role="tabpanel">
                                                        <div class="director-content-text">
                                                            <?php echo nl2br(htmlentities($result20->director_message)); ?>
                                                        </div>
                                                    </div>
                                                </div>
