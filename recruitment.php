	...
	<main>
		...
		<div class="container mt-5">
			...
			<div class="row mb-2">
			    ...
			    <div class="col-sm-4 ">
			        <a class="genric-btn success float-right" href="archives-en.php" style="background-color: #003679;">Archives »</a>
			    </div>
			</div>
						...
						<table id="dataTable" class="table table-bordered table-hover" width="100%" cellspacing="0">
							<thead>
								<tr>
									...
									<th style="background-color:#fff;color:black;">Title</th>
									<th style="background-color:#fff;color:black;">Upload Date</th>
									<th style="background-color:#fff;color:black;">Category</th>
									<th style="background-color:#fff;color:black;">Status</th>
									<th style="background-color:#fff;color:black;">Last date/Interview date</th>
									<th style="background-color:#fff;color:black;">Document</th>
								</tr>
							</thead>
							...
							<tbody>
								...
								$name = 'recruitment';
								$status = 'Open';
								$sql = "SELECT * from info_en where type = (:type) and status = (:status) ORDER BY id DESC";
								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) {				?>
										<tr>
											...
											?>
													<td class="text-nowrap"><i class="fa fa-angle-right" aria-hidden="true" style="color:blue"></i>&nbsp;<a href="admin/en_doc/<?php echo htmlentities($result19->doc_main); ?>" target="_blank">Advertisement <i class="fa fa-download" aria-hidden="true"></i></a><br>
														<?php if($result19->doc_apform==""){
														...
														for ($i = 0; $i < $length; $i++) {
															echo '<i class="fa fa-angle-right" aria-hidden="true" style="color:blue"></i>&nbsp;<a href="admin/en_doc/' . $subjectOutput[$i] . '" target="_blank">' . $strOutput[$i] . '&nbsp;<i class="fa fa-download" aria-hidden="true" ></i></a><br>';
