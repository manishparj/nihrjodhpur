...
<head>
    ...
    <title>A.S. Paintal chair | ICMR-NIIRNCD </title>
														...
														<div class="item">
															<div class="client-box style-2">
																<div class="testimonial-pic">
																	<img src="admin/img/our_team/aspaintalchair/<?php echo htmlentities($result->img); ?>" />
																</div>
																<div class="testimonial-text">

																	<p class="card-text"><b><?php echo htmlentities($result->name_hi); ?></b><br>
																	Dr. A. S. Paintal Distinguished Scientist ICMR-NIIRNCD Chair<br>
																	& पूर्व अतिरिक्त. महानिदेशक,<br>
																	भारतीय चिकित्सा अनुसंधान परिषद<br><br><br></p>
																<!-- <a href="https://main.icmr.nic.in/content/director-general" class="genric-btn success  arrow medium border" style="background-color: #003679;">View Profile »</a> -->
