...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) { 
        ...
        $sql1 = "UPDATE announcement SET messages=NULLIF('$text1','') WHERE id=$edid";
    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <h1 class="h3 mb-0 text-gray-800"><?php echo 'Announcement'; ?></h1>
                            <a href="insertannouncement.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-down fa-sm text-white-50"></i> Create</a>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <thead>
                                            <tr>
                                                <th>#</th>
                                                <th class="text-nowrap">Announcement</th>
                                                <th>link docuemnt</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                                    ...
                                                    ?>
                                                     <tr>                                                        
                                                        ...
                                                        if ($result->doc_upload) { ?>
                                                         <td><a href="./en_doc/<?php echo htmlentities($result->doc_upload);?>"  />document</a></td>
                                                         <?php                                                               
                                                        } else {
                                                            echo '<td> -</td>';
                                                        } ?>
                                                        ...
                                                        <td class="text-nowrap">
																	...
																	<a href="viewannouncement.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
																</td>                                                  
                                                    </tr>
        ...
        <script>
            $('.modalLink').click(function() {
                ...
                $.ajax({
                    url: "editannouncement.php?famID=" + famID,
                    cache: false,
