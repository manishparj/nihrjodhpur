...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql1 = "UPDATE info_hi SET title=(:var1), type=(:var2), upl_date=(:var3), status=(:var4), last_dt=(:var5), category=NULLIF('$category', '') WHERE id=$edid";
    ...
    <body id="page-top">
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {                ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                                <td class="text-nowrap"><i class="fa fa-angle-right" aria-hidden="true" style="color:blue"></i>&nbsp;<a href="hi_doc/<?php echo htmlentities($result19->doc_main); ?>" target="_blank">Document <i class="fa fa-download" aria-hidden="true"></i></a><br>
                                                                    <?php
                                                            ...
                                                            <?php }
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="tenderh.php?del=<?php echo $result->id; ?>&dcid=<?php echo htmlentities($result19->doc_id); ?>&name=<?php echo htmlentities($name); ?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
                                                                </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
        ...
        <script>
            $('.modalLink').click(function() {
                ...
                $.ajax({
                    url: "edit2h.php?famID=" + famID + "&famAddr=" + famAddr,
                    cache: false,
