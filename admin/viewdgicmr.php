...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) { 
        ...
        $sql2 = "UPDATE dgicmr SET img=(:var0) WHERE id=$edid";
        ...
        $sql1 = "UPDATE dgicmr SET name_en=NULLIF('$emp_name', ''), name_hi=NULLIF('$emp_name_hi','') WHERE id=$edid";
    ...
    <body id="page-top">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            ...
                            <h1 class="h3 mb-0 text-gray-800"><?php echo 'DG-ICMR'; ?></h1>
                                                ...
                                                foreach ($results as $result) {          
                                                    ?>
                                                     <tr>                                                        
                                                        ...
                                                        <td><img src="img/our_team/dg-icmr/<?php echo htmlentities($result->img);?>" style="width:50px;" /></td>
        ...
        <script>
            $('.modalLink').click(function() {
                ...
                $.ajax({
                    url: "editdgicmr.php?famID=" + famID,
                    cache: false,
