...
$sql9 = "SELECT * FROM info_en WHERE id = ?";
$stmt = $dbh->prepare($sql9);
$stmt->bindParam(1, $famID); // Binding the parameter to the statement

$stmt->execute();
$results9 = $stmt->fetchAll(PDO::FETCH_OBJ);
...
<div class="modal-body card mb-12">
    ...
    <div class="card-body">
        <form method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label>Advt Category<span style="color:red">*</span></label>
                    <select id="category" name="category" class="form-control">
                        <option value="<?php echo htmlentities($result20->category);?>">
                            <?php echo htmlentities($result20->category);?></option>
            ...
            <?php
			$sql8 = "SELECT * from doc_en where doc_id = $result20->id";
