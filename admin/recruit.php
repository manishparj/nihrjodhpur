...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql1 = "UPDATE info_en SET title=(:var1), type=(:var2), upl_date=(:var3), status=(:var4), last_dt=(:var5), category=(:var6) WHERE id=$edid";
											...
											if ($query->rowCount() > 0) {
												foreach ($results as $result) {				?>
													<tr>
														...
														?>
																<td class="text-nowrap"><i class="fa fa-angle-right" aria-hidden="true" style="color:blue"></i>&nbsp;<a href="en_doc/<?php echo htmlentities($result19->doc_main); ?>" target="_blank">Advt <i class="fa fa-download" aria-hidden="true"></i></a><br>
																...
																<td class="text-nowrap">
																	...
																	<a href="recruit.php?del=<?php echo $result->id; ?>&dcid=<?php echo htmlentities($result19->doc_id); ?>&name=<?php echo htmlentities($name); ?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
																</td>
																<?php }
														} ?>
													</tr>
	...
	<script src="vendor/datatables/dataTables.bootstrap4.min.js"></script>
		...
		<script>
			$('.modalLink').click(function() {
				...
				$.ajax({
					url: "edit1.php?famID=" + famID + "&famAddr=" + famAddr,
					cache: false,
