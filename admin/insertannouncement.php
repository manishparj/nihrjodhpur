...
if(isset($_POST['submit']))
{
	...
	if (!empty($_FILES['a_pdf']['name'])) {
	  ...
	  $sqlnoti="insert into announcement (messages, doc_upload) values ('$text1','$doc_main')";
 		
	} else {
		// File upload is empty, insert only text values into the database
		$sqlnoti="insert into announcement (messages) values ('$text1')";
													...
													<div class="form-row">
														...
														<div class="form-row">
															...
															<div class="form-group col-md-10">
																<textarea id="text1" name="text1" rows="4" cols="100" placeholder="type/paste here.." style="padding:10px;" required></textarea>
															</div>
														</div>
