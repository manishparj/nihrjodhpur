...
@keyframes gradientIcon {
    ...
    <main style="margin-bottom: 6%;">
        ...
        <!-- slider Area End-->
                ...
                <img src="admin/vendor/fontawesome-free/svgs/solid/at.svg" alt="eGov email">
                <h5>नया eGov-ईमेल</h5>
                </a>
                <a href="./sci-admin/" class="tile" target="_blank">
                <img src="admin/vendor/fontawesome-free/svgs/brands/edge.svg" alt="Scientists Panel">
                <h5>वैज्ञानिक पैनल</h5>
                </a>


                <a href="hviewforms.php" class="tile">
                <img src="admin/vendor/fontawesome-free/svgs/solid/list.svg" alt="Forms">
                <h5>पत्र</h5>
                </a>


                <a href="hviewcircular.php" class="tile">
