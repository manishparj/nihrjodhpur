            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 justify-content-between px-1" style="line-height: 25px;">
                        ...
                        <a class="px-1 f-left" style="font-size: 0.88em;color: #333;" href="hemployee-corner.php">Employee Corner /</a>
                        <a class="px-1 f-left" style="font-size: 0.88em;color: #333;" href="hrti-act.php">RTI</a>
                        ...
                        <span class="f-right"> <select style="border: 0pxsolid rgb(74, 74, 74);background-color:transparent;" onchange="if (this.value) window.location.href=this.value">
                                <option value="hindex.php" selected>हिंदी</option>
