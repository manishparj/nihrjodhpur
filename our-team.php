			...
			<div class="container team-section">
				...
				<h2 class="section-title">A. Director</h2>
					<div class="team-grid">
						...
						<div class="team-card" style="position: relative;">
							...
							<img src="admin/img/our_team/<?= $name ?>/<?= htmlentities($r->emp_image) ?>" style="object-fit: fill;">

							<div class="card-title"><?= htmlentities($r->emp_name) ?></div>

							<div class="team-details">

								<div class="team-row">
									<i class="fa fa-id-badge icon"></i>
									<span><?= strtoupper($r->emp_desig) ?></span>
								</div>
				...
				<div class="team-grid">
					...
					<div class="team-card">
						...
						<div class="team-details">
							<i class="fa fa-id-badge icon"></i> <?= htmlentities($r->emp_desig) ?><br>
