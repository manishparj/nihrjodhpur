...
<html class="no-js" lang="zxx">
    ...
    <main>
        ...
        <section class="container mt-5">
            <div class="container">
                <div class="row widget_gallery">
                <ul id="masonry" class="dlab-gallery-listing gallery-grid-4 gallery mfp-gallery col-md-12 p-lr0">
									<div class="row">
										<?php
										...
										?>
												...
												<li class="card-container col-lg-3 col-md-6 col-sm-6 wow zoomIn" data-wow-delay="0.2s">
													<a href="hphotogalleryview.php?eventid=<?php echo htmlentities($result->id)?>">
														<div class="dlab-box frame-box m-b30">
															<div class="dlab-thum dlab-img-overlay1 ">
																<img src="content/events/<?php echo htmlentities($result->cover); ?>" />

															</div>
															<h5 class="text-center text-capitalize" style="background-color:#003669 ;color:aliceblue;font-size:medium;"><?php echo htmlentities($result->title); ?>&nbsp;<?php echo htmlentities($result->year); ?> </h5>
														</div>
													</a>
												</li>
