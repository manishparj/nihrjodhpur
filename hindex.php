                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {
                                                if ($result->doc_upload) { ?>
                                                    <a style="font-weight:bold;color:red" href="./admin/en_doc/<?php echo htmlentities($result->doc_upload); ?>" target="_blank"><?php echo htmlentities($result->messages); ?></a>&nbsp;|
                                                <?php
                                                } else { ?>
                                                    <a style="font-weight:bold;color:red" href="#"><?php echo htmlentities($result->messages); ?></a>&nbsp;|
                                        <?php
                                                }
                                            }
                                        }
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        <div class="shadow p-3 mb-5 bg-white rounded" style="border: 1px solid rgba(0,0,0,0.15);">
                            <h3 class="card-title text-center pb-4 font-weight-bold" style="color: #012f5f;margin-top:30px;margin-bottom: 5px;font-size: 26px;font-weight: 550;">निदेशक की डेस्क से</h3>
                            <p class="card-text text-justify" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif">यह संस्थान जोधपुर में स्थित है और इसका पूर्ववर्ती नाम “मरुस्थलीय आयुर्विज्ञान अनुसंधान केंद्र” था, जो बदल गया है। जैसा कि नाम से पता चलता है, हमारा ध्यान असंचारी रोगों के बढ़ते खतरों से निपटने के तरीकों की पहचान करने और नवीन प्रणालियों के अनुसंधान करने पर है।...</p>
                             <a class="genric-btn success" href="habout-director.php" style="width: 100%;background-color: #003679;">अधिक पढ़ें... »</a>
                    </div>
                </div>
            ...
            <div class="container ">
                <div class="row d-flex justify-content-between">
                    <div class="col-xl-4 col-lg-5 col-md-5 request-content">
                        <div class="nav flex-column nav-pills form-box" id="v-pills-tab" role="tablist"
                            aria-orientation="vertical">
                            <a class="nav-link active px-lg-5 py-5 m-1 text-left" id="v-pills-home-tab" data-toggle="pill"
                                href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><i
                                    class="fa fa-bullhorn"></i>&nbsp;नवीनतम जानकारी</a>
                            <a class="nav-link px-lg-5 py-5 m-1 text-left" id="v-pills-profile-tab" data-toggle="pill"
                                href="#v-pills-profile" role="tab" aria-controls="v-pills-profile"
                                aria-selected="false"><i class="fa fa-calendar-check"></i>&nbsp;कार्यक्रम</a>
                            <a class="nav-link px-lg-5 py-5 m-1 text-left"
                                href="hemployee-corner.php" ><i class="fa fa-list"></i>&nbsp;परिपत्र</a>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-8 col-lg-7 col-md-7 form-box2" style="height:400px;">
                        <div class="tab-content p-3" id="v-pills-tabContent" style="font-size:14px ;">
                            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                ...
                                <marquee style="height:300px;" direction="up" behavior="scroll" scrollamount="4" height="70%" onmouseover="this.stop();" onmouseout="this.start();"">
							<?php

							$sql = "SELECT * from info_hi where type = 'whatsnew' or type = 'recruitment' or type = 'circular' ORDER BY id DESC LIMIT 5";
							$query = $dbh->prepare($sql);
							$query->execute();
							$results = $query->fetchAll(PDO::FETCH_OBJ);
							$cnt = 1;
									...
									if ($query9->rowCount() > 0) {
										foreach ($results9 as $result19) {				?>
											<ul class="unordered-list">
												<li class="text-justify"><a href="admin/hi_doc/<?php echo htmlentities($result19->doc_main); ?>" target="_blank" style="color:white;"><?php echo htmlentities($result->title); ?></a>
							...
							<?php }
                                ...
                                <a href="hviewnews.php" class="genric-btn success circle arrow medium f-right mb-2 border" style="background-color: #003679;">अधिक पढ़ें »</a>

                            </div>
                            <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                aria-labelledby="v-pills-profile-tab">
                                <marquee style="height:300px;" direction="up" behavior="scroll" scrollamount="4" height="90%" onmouseover="this.stop();" onmouseout="this.start();">
							<?php

							$sql1 = "SELECT * from info_hi where type = 'event' ORDER BY id DESC";
							...
							if ($query1->rowCount() > 0) {
								foreach ($results1 as $result11) {				?>
									...
									<?php
									$sql91 = "SELECT * from doc_hi where doc_id = $result11->id";
									$query91 = $dbh->prepare($sql91);
									$query91->execute();
									$results91 = $query91->fetchAll(PDO::FETCH_OBJ);
									if ($query91->rowCount() > 0) {
										foreach ($results91 as $result191) {				?>
											<ul class="unordered-list border-0">
												<li class="text-justify"><a href="admin/hi_doc/<?php echo htmlentities($result191->doc_main); ?>" target="_blank" style="color:white;"><?php echo htmlentities($result11->title); ?></a>
                        <hr style="margin-top:5px;opacity:0.3;border:1px solid #fff;">
												</li>
											</ul>
									<?php }
									} ?>
                        ...
                        <a href="hview.php" class="genric-btn success circle arrow medium f-right mb-2 border" style="background-color: #003679;">See More »</a>
            ...
            <div class="container">
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle footer-new">
                                <h4 class="font-weight-bold">सम्पर्क करें</h4>
                                <div class="line"></div>
                                <ul>
                                    <li> <span><i class="fa fa-phone"></i>
                                    नई पाली रोड, -<br>
                                    जोधपुर- 342005</span> </li>

                                    <li> <span><i class="fa fa-map-marker-alt"></i>
                                    फोन : 0291-2722403, <br> फैक्स : 0291-2720618</span> </li>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle footer-new1">
                                <h4 class="font-weight-bold">सम्बंधित बंध</h4>
                                <div class="line"></div>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle footer-new1">
                                <h4 class="font-weight-bold">कोविड -19 की जानकारी</h4>
                                <div class="line"></div>

                                <ul>
                                    <li><span><i class="fa fa-angle-right"></i>&nbsp;<a href="covidinfo.php">कोविड -19<br></a></span> </li>
