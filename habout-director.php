            ...
            <div class="container">
                <div class="row">
                    <div class="card-deck col-lg-12 ">
                        ...
                        $sql = "SELECT * from emp_details where emp_type = (:type)";
                        ...
                        if ($query->rowCount() > 0) {
                            foreach ($results as $result) { ?>
                                ...
                                <div class="card col-lg-4 text-center border-0">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"><?php echo htmlentities($result->emp_name_hi); ?></h5>
                                        <p class="card-text"><?php echo htmlentities($result->emp_desig_hi); ?></p>
                                                ...
                                                <div class="tab-content mb-100" id="myTabContent">
                                                    <div class="tab-pane fade in active show" id="tab1" role="tabpanel" aria-labelledby="tab--1">
                                                        <div class="credit-tab-content ">
                                                            ...
                                                            <div class="credit-tab-text">
                                                                <p id="bg1" class="card-text text-justify" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif"><?php echo htmlentities($result20->director_profile_hi); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab--2">
                                                        <div class="credit-tab-content">
                                                            <!-- Tab Text -->
                                                            <div class="credit-tab-text">
                                                                <p id="bg2" class=" card-text text-justify" style="font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif"><?php echo htmlentities($result20->director_message_hi); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
