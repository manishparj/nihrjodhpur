                ...
                <div class="modern-tab-card">
                    ...
                    <div class="modern-tab-content">
                        ...
                        function renderTabItems(PDO $dbh, string $type, string $panelId, string $viewAllHref, string $viewAllLabel, bool $active = false): void {
                            $sql  = "SELECT * FROM info_en WHERE type = :type ORDER BY id DESC LIMIT 15";
                        ...
                        <?php
                        /* What's New */
                        $sql_wn = "SELECT * FROM info_en WHERE type IN ('whatsnew','recruitment','events') ORDER BY id DESC LIMIT 10";
                        ...
                        <?php renderTabItems($dbh, 'event',    'events',    'view.php',         'View All Events'); ?>
                        <?php renderTabItems($dbh, 'circular', 'circulars', 'viewcircular.php', 'View All Circulars'); ?>
                        <?php renderTabItems($dbh, 'tenders',  'tenders',   'tenders.php',      'View All Tenders'); ?>
        ...
        <div class="info-unified-card">
            ...
            <div class="info-grid-unified">
                ...
                <div class="info-column director-column">
                    <div class="column-header">
                        <h3 class="column-title">From the Director's Desk</h3>
                    ...
                    <div class="director-content">
                        ...
                        <div class="director-info">
                            <strong class="director-name-text">
                                <?= htmlspecialchars($director_info->emp_name ?? 'Director', ENT_QUOTES) ?>
                            </strong>
                            <span class="director-designation">
                                <?= htmlspecialchars($director_info->emp_desig ?? 'Director, ICMR-NIHR Jodhpur', ENT_QUOTES) ?>
                            </span>
                        </div>

                        <p class="director-message-text">
                            <?php
                            if ($director_profile_data && $director_profile_data->director_message) {
                                $msg = strip_tags($director_profile_data->director_message);
                ...
                <div class="info-column welcome-column">
                    <div class="column-header">
                        <h3 class="column-title">Welcome to ICMR-National Institute of Health Research, Jodhpur</h3>
                        <div class="column-line"></div>
                    </div>
                    ...
                    <div class="welcome-content">
                        <div class="stats-row">
                            ...
                            <div class="stat-card">
                                ...
                                <span class="stat-label">Premier Institute</span>
                            </div>
                        </div>

                        <div class="welcome-text-block">
                            <p class="welcome-paragraph">
                                The National Institute for Health Research (NIHR), located in Jodhpur, was originally established
                                on <strong>27 June 1984</strong> as the Desert Medicine Research Centre (DMRC). It was later renamed
                                the National Institute for Implementation Research on Non-Communicable Diseases (NIIRNCD) on
                                <strong>7 December 2019</strong>, and redesignated as <strong>NIHR on 29 April 2026</strong>.
                            </p>
                            <p class="welcome-paragraph">
                                The Institute houses state-of-the-art facilities for basic laboratory-based research, clinical
                                studies, and implementation research in the field of non-communicable diseases. We are committed
                                to advancing health research and improving healthcare delivery across India.
                            </p>
                        </div>
            ...
            <div class="collaborators-section">
                <div class="collaborators-header">
                    <h4>Our Collaborators &amp; Partners</h4>
            ...
            <div class="leadership-grid-unified top">
                ...
                $ministers = [
                    [
                        ...
                        'title' => "Hon'ble Union Minister of Health and Family Welfare",
                    ...
                    <div class="leadership-card-inner">
                        ...
                        <div class="leadership-card-content">
                            ...
                            <div class="leadership-read-more">
                                <a href="<?= htmlspecialchars($leader['url'], ENT_QUOTES) ?>" target="_blank" rel="noopener">View Profile</a>
                                <i class="fas fa-arrow-right" aria-hidden="true"></i>
                            </div>
                        </div>
                    </div>
        ...
        <div class="unified-card">
            ...
            <div class="unified-grid">
                ...
                <div class="unified-column contact-column text-center">
                    <h3 class="column-title">Visit Us</h3>
                ...
                <div class="unified-column text-center">
                    <h3 class="column-title">Holiday Calendar 2026</h3>
                    <div class="section-divider-premium" style="margin-bottom:20px">
                        <span class="divider-line-premium"></span>
                    </div>
                ...
                <div class="unified-column social-column text-center">
                    ...
                    <div class="social-stats-unified">
                        <span><i class="fas fa-newspaper" aria-hidden="true"></i> Weekly Updates</span>
                        <span><i class="fas fa-chart-line" aria-hidden="true"></i> Research News</span>
                    </div>
                </div>
