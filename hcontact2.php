...
<html class="no-js" lang="zxx">
    ...
    <section class="contact-section">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                <h2 class="contact-title">संपर्क करे</h2>
                </div>
                <div class="col-lg-8">
                <?php if ($error) { ?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
                <div id="responseMessage"></div>
                <form class="form-contact contact_form" method="post" id="myForm" novalidate="novalidate" autocomplete="off">

                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                <label for="">Message<span style="color:red">*</span></label>
                                    <textarea class="form-control w-100" name="message" id="message" rows="4" cols="50" oninput="limitTextarea()"  placeholder=" Enter Message" required></textarea>
                                    <small>Word Count Limit: <span id="charCount">250</span></small></div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                <label for="">Name<span style="color:red">*</span></label>
                                    <input class="form-control valid" name="name" id="name" type="text" placeholder = 'Enter your name' placeholder="Enter your name" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-6">
                                ...
                                <label for="">Mobile<span style="color:red">*</span></label>
                                    <input class="form-control" name="subject" id="subject" type="number" max="10" min="10" placeholder = 'Enter Mobile No.' >
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
...
<script>
  ...
  function cap(){
    ...
    $("#myForm").submit(function(event) {
      ...
      $.ajax({
        type: "POST",
        url: "proccess_form.php", // Replace with the URL of your PHP processing script
        data: formData,
        ...
        //   alert("Form submitted successfully!");
          // You can update the UI, display success messages, or perform other actions here.
        },
        ...
        //   }, 3000);
                  ...
                  alert("Oops!Please enter a valid captcha!");
                  return false;
                }
               }
</script>
