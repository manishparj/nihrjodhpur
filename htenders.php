					...
					<div class="card-body" style="background-color:#fff;color:black;border:0ch;margin:2px;font-size:small;">
						<div class="table-responsive">
							<table id="dataTable" class="table table-bordered table-hover" width="100%" cellspacing="0">
								...
								<thead>
									<tr>
										<th style="background-color:#fff;color:black;">क्र.स.</th>
										<th style="background-color:#fff;color:black;">	निविदा</th>
										<th style="background-color:#fff;color:black;">अपलोड की तिथि</th>
										<th style="background-color:#fff;color:black;">स्थिति</th>
										<!--<th>Category</th>-->
										<th style="background-color:#fff;color:black;">अंतिम तिथि</th>
								...
								<tbody>
									...
									$sql = "SELECT * from info_hi where type = 'tenders' ORDER BY id DESC";
                        ...
                        <td><?php echo htmlentities($newDateString1); ?></td>
												...
												?>
														<td class="text-nowrap"><i class="fa fa-angle-right" aria-hidden="true" style="color:blue"></i>&nbsp;<a href="admin/hi_doc/<?php echo htmlentities($result19->doc_main); ?>" target="_blank">Document <i class="fa fa-download" aria-hidden="true"></i></a><br>
															<?php
															$length = count($strOutput);

															for ($i = 0; $i < $length; $i++) {
																echo '<i class="fa fa-angle-right" aria-hidden="true" style="color:blue"></i>&nbsp;<a href="admin/hi_doc/' . $subjectOutput[$i] . '">' . $strOutput[$i] . '&nbsp;<i class="fa fa-download" aria-hidden="true"></i></a><br>';
